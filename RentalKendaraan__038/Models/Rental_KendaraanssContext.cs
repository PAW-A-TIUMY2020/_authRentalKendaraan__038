...
{
    public partial class Rental_KendaraanssContext : IdentityDbContext
    {
        public Rental_KendaraanssContext()
        {
        }

        public Rental_KendaraanssContext(DbContextOptions<Rental_KendaraanssContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Peminjaman>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCustomerNavigation)
                    ...
                    .HasConstraintName("FK_Peminjaman_Customer1");
