...
namespace RentalKendaraan__038.Controllers
{
    public class KondisiKendaraansController : Controller
    {
        private readonly Rental_KendaraanssContext _context;

        public KondisiKendaraansController(Rental_KendaraanssContext context)
        {
            _context = context;
        }
